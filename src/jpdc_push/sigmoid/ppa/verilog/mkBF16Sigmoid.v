...
//
// On Sun Sep 13 00:07:43 IST 2026
//
//
// Ports:
// Name                         I/O  size props
...
module mkBF16Sigmoid(CLK,
  ...
  reg [7 : 0] IF_s1_exp_8_EQ_129_0_THEN_IF_s1_sign_1_THEN_IF_ETC___d40;
  reg [6 : 0] IF_s2_exp_8_EQ_129_0_THEN_IF_s2_sign_1_THEN_0__ETC___d91;
  wire [7 : 0] new_exp__h1124, new_exp__h1225, new_exp__h1252, new_exp__h1255;
  wire [6 : 0] new_man__h1495,
	       new_man__h1522,
	       new_man__h1568,
	       new_man__h1614,
	       new_man__h1661,
  ...
  assign result_valid$EN = stage4[0] || EN_getResult || result_valid ;
  ...
  assign s2_new_exp$D_IN =
	     (s1_exp <= 8'd129) ?
	       IF_s1_exp_8_EQ_129_0_THEN_IF_s1_sign_1_THEN_IF_ETC___d40 :
	       new_exp__h1124 ;
  ...
  assign s3_new_man$D_IN =
	     (s2_exp <= 8'd129) ?
	       IF_s2_exp_8_EQ_129_0_THEN_IF_s2_sign_1_THEN_0__ETC___d91 :
	       7'd0 ;
  assign s3_new_man$EN = stage3[0] ;

  // register stage1
  assign stage1$D_IN = EN_put_data ? { put_data_data, 1'd1 } : 17'd0 ;
  assign stage1$EN = 1'd1 ;
  ...
  // remaining internal signals
  assign new_exp__h1124 = s1_sign ? 8'd0 : 8'd127 ;
  assign new_exp__h1225 = s1_sign ? (s1_man[6] ? 8'd122 : 8'd123) : 8'd126 ;
  assign new_exp__h1252 = s1_sign ? 8'd124 : 8'd126 ;
  assign new_exp__h1255 = s1_sign ? 8'd125 : 8'd126 ;
  assign new_man__h1495 = s2_sign ? 7'd0 : { 3'h7, s2_man[6:3] } ;
  assign new_man__h1522 = s2_sign ? ~s2_man : { 2'h3, s2_man[6:2] } ;
  assign new_man__h1568 = s2_sign ? ~s2_man : { 1'h1, s2_man[6:1] } ;
  assign new_man__h1614 =
	     s2_sign ? { 1'h0, ~s2_man[6:1] } : { 2'h1, s2_man[6:2] } ;
  assign new_man__h1661 =
	     s2_sign ? { 2'h3, ~s2_man[6:2] } : { 3'h1, s2_man[6:3] } ;
  assign new_man__h1708 =
	     s2_sign ? { 3'h7, ~s2_man[6:3] } : { 4'h1, s2_man[6:4] } ;
  assign new_man__h1754 =
	     s2_sign ? { 4'hF, ~s2_man[6:4] } : { 5'h01, s2_man[6:5] } ;
  always@(s1_exp or
	  new_exp__h1255 or
	  new_exp__h1252 or new_exp__h1225 or s1_sign or s1_man)
  begin
    case (s1_exp)
      8'd127:
	  IF_s1_exp_8_EQ_129_0_THEN_IF_s1_sign_1_THEN_IF_ETC___d40 =
	  ...
	  IF_s1_exp_8_EQ_129_0_THEN_IF_s1_sign_1_THEN_IF_ETC___d40 =
		...
		(s1_man[6] ?
		   ...
		   8'd121) :
		8'd126;
      default: IF_s1_exp_8_EQ_129_0_THEN_IF_s1_sign_1_THEN_IF_ETC___d40 =
		   new_exp__h1255;
    endcase
  end
  always@(s2_exp or
	  ...
	  new_man__h1661 or
	  new_man__h1614 or
	  new_man__h1568 or new_man__h1522 or new_man__h1495)
  begin
    case (s2_exp)
      8'd124:
	  IF_s2_exp_8_EQ_129_0_THEN_IF_s2_sign_1_THEN_0__ETC___d91 =
	  ...
	  IF_s2_exp_8_EQ_129_0_THEN_IF_s2_sign_1_THEN_0__ETC___d91 =
	      new_man__h1495;
      default: IF_s2_exp_8_EQ_129_0_THEN_IF_s2_sign_1_THEN_0__ETC___d91 =
		   new_man__h1754;
    endcase
  end
