...
VL_INLINE_OPT void VmkTb_COP___024root___nba_sequent__TOP__131(VmkTb_COP___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VmkTb_COP___024root___nba_sequent__TOP__131\n"); );
    ...
    if (vlSelfRef.RST_N) {
        if (VL_UNLIKELY((((IData)(vlSelfRef.mkTb_COP__DOT__cop__DOT__WILL_FIRE_RL_wait_sa2_complete) 
