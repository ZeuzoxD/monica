...
VL_INLINE_OPT void VmkTb_COP___024root___nba_sequent__TOP__165(VmkTb_COP___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VmkTb_COP___024root___nba_sequent__TOP__165\n"); );
    ...
    if (vlSelfRef.RST_N) {
        if (VL_UNLIKELY(((0x7a120U < vlSelfRef.mkTb_COP__DOT__cycle)))) {
    ...
    if (vlSelfRef.RST_N) {
        if (VL_UNLIKELY((vlSelfRef.mkTb_COP__DOT__cop__DOT__WILL_FIRE_RL_sa1_collect_result))) {
            VL_WRITEF_NX("[Cycle %0#] SA1: Row_group=%0#, Input_chunk=%0# done, accumulated\n",0,
                         32,vlSelfRef.mkTb_COP__DOT__cop__DOT__cycle_count,
                         6,(IData)(vlSelfRef.mkTb_COP__DOT__cop__DOT__sa1_output_row_idx),
    ...
    if (vlSelfRef.RST_N) {
        if (VL_UNLIKELY((vlSelfRef.mkTb_COP__DOT__cop__DOT__WILL_FIRE_RL_sa2_load_activations))) {
            VL_WRITEF_NX("[Cycle %0#] SA2: Row_group=%0#, Input_chunk=%0#/17, Elements[%0#:%0#]\n",0,
                         32,vlSelfRef.mkTb_COP__DOT__cop__DOT__cycle_count,
                         6,(IData)(vlSelfRef.mkTb_COP__DOT__cop__DOT__sa2_output_row_idx),
                         6,vlSelfRef.mkTb_COP__DOT__cop__DOT__sa2_input_chunk_idx,
                         8,(0xf0U & ((IData)(vlSelfRef.mkTb_COP__DOT__cop__DOT__sa2_input_chunk_idx) 
                                     << 4U)),8,(0xfU 
                                                | (0xf0U 
    ...
    if (vlSelfRef.RST_N) {
        if (VL_UNLIKELY(((4U == (IData)(vlSelfRef.mkTb_COP__DOT__cop__DOT__sa1_state))))) {
            VL_WRITEF_NX("[Cycle %0#] SA1: Stored row_group=%0# outputs [%0#:%0#]\n",0,
                         32,vlSelfRef.mkTb_COP__DOT__cop__DOT__cycle_count,
                         6,(IData)(vlSelfRef.mkTb_COP__DOT__cop__DOT__sa1_output_row_idx),
                         8,(0xf0U & ((IData)(vlSelfRef.mkTb_COP__DOT__cop__DOT__sa1_output_row_idx) 
                                     << 4U)),8,(0xfU 
                                                | (0xf0U 
    ...
    if (vlSelfRef.RST_N) {
        if (VL_UNLIKELY((((4U == (IData)(vlSelfRef.mkTb_COP__DOT__cop__DOT__sa1_state)) 
            ...
            VL_WRITEF_NX("[Cycle %0#] SA1: ALL 272 OUTPUTS COMPLETE!\n",0,
                         32,vlSelfRef.mkTb_COP__DOT__cop__DOT__cycle_count);
        }
    }
    if (vlSelfRef.RST_N) {
    ...
    if (vlSelfRef.RST_N) {
        if (VL_UNLIKELY((((IData)(vlSelfRef.mkTb_COP__DOT__cop__DOT__WILL_FIRE_RL_sa2_collect_result) 
            ...
            VL_WRITEF_NX("[Cycle %0#] SA2: Row_group=%0# COMPLETE (all 17 chunks accumulated)\n",0,
                         32,vlSelfRef.mkTb_COP__DOT__cop__DOT__cycle_count,
                         6,(IData)(vlSelfRef.mkTb_COP__DOT__cop__DOT__sa2_output_row_idx));
        }
    }
    ...
    if (vlSelfRef.RST_N) {
        if (VL_UNLIKELY((vlSelfRef.mkTb_COP__DOT__cop__DOT__WILL_FIRE_RL_readback_issue_read))) {
            VL_WRITEF_NX("[Cycle %0#] READ-BACK: Issued read BRAM=%0#, chunk=%0#, offset=%0#, addr=%0#\n",0,
                         ...
                         10,vlSelfRef.mkTb_COP__DOT__cop__DOT__read_addr___05Fh12213870);
        }
    }
    if (vlSelfRef.RST_N) {
    ...
    if (vlSelfRef.RST_N) {
        if (VL_UNLIKELY((((IData)(vlSelfRef.mkTb_COP__DOT__cop__DOT__WILL_FIRE_RL_one_last_rule) 
                          & (IData)(vlSelfRef.mkTb_COP__DOT__cop__DOT__readback_complete_6353_AND_readback_values_642_ETC___05F_d49271))))) {
    ...
    if (vlSelfRef.RST_N) {
        if (VL_UNLIKELY((vlSelfRef.mkTb_COP__DOT__cop__DOT__readback_values__024EN))) {
            VL_WRITEF_NX("[Cycle %0#] READ-BACK: Collected BRAM=%0#, chunk=%0#, offset=%0#, value=%x\n",0,
                         ...
                         2,vlSelfRef.mkTb_COP__DOT__cop__DOT__readback_chunk_id,
                         3,(IData)(vlSelfRef.mkTb_COP__DOT__cop__DOT__readback_addr_offset),
                         16,vlSelfRef.mkTb_COP__DOT__cop__DOT__IF_readback_bram_id_6356_EQ_0_6357_THEN_bram_x_ETC___05F_d46427);
        }
    }
    if (vlSelfRef.RST_N) {
