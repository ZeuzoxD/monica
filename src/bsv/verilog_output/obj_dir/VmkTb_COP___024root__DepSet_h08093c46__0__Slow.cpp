...
VL_ATTR_COLD void VmkTb_COP___024root___eval_initial__TOP__0(VmkTb_COP___024root* vlSelf) {
    ...
    VL_ASSIGN_W(3072,vlSelfRef.mkTb_COP__DOT__cop__DOT__sa1_final_output, VmkTb_COP__ConstPool__CONST_h3d7084e4_0);
    ...
    vlSelfRef.mkTb_COP__DOT__cop__DOT__sa1_output_row_idx = 0xaU;
    ...
    vlSelfRef.mkTb_COP__DOT__cop__DOT__sa1_weight_col_idx = 0xaU;
    vlSelfRef.mkTb_COP__DOT__cop__DOT__sa1_weight_matrix_idx = 0xaU;
    ...
    vlSelfRef.mkTb_COP__DOT__cop__DOT__sa2_input_chunk_idx = 0xaU;
    ...
    vlSelfRef.mkTb_COP__DOT__cop__DOT__sa2_weight_col_idx = 0xaU;
    vlSelfRef.mkTb_COP__DOT__cop__DOT__sa2_weight_matrix_idx = 0xaU;
